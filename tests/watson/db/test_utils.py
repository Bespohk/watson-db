...
class TestPaginator(object):
    ...
    def test_iter_results(self):
        paginator = utils.Pagination(session.query(Obj), page=1, limit=2)
    ...
    def test_no_results(self):
        paginator = utils.Pagination(session.query(Obj).filter(Obj.value == 10), page=2)
    ...
    def test_next_previous_page(self):
        ...
        paginator = utils.Pagination(session.query(Obj), page=3, limit=2)
